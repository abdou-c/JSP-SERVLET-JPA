        ...
        <ul class="nav top-menu">
          ...
          <li id="header_notification_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended notification">
              ...
              <li>
                <a href="http://localhost:8080/SenForage/index.jsp">
                  <span class="label label-warning"><i class="fa fa-bell"></i></span>
                  La mÃ©moire ne rÃ©pond pas.
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              <i class="fa fa-tasks"></i>
              <span>Gestions de la Clientèle</span>
              </a>
            <ul class="sub">
          ...
          <div class="col-lg-12">
            <div class="row content-panel">
              ...
              <div class="col-md-4 profile-text">
                ...
                <p>Sen-Forage est une entreprise évoluant dans la production et la distribution d'eau pour les villageois du nord du Sénégal.</p>
                <br>
